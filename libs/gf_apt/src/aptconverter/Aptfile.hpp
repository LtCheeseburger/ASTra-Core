...
private:
	...
	static unsigned int GetFrameItemSize(Frame *fr);
        static unsigned int GetFrameItemPointerSize(Frame *fr);
        static unsigned int GetFrameItemPointerPointerSize(Frame *fr);
        static unsigned int GetFrameItemPointerPointerPointerSize(Frame *fr);
        static unsigned int GetFrameItemPointerPointerPointerPointerSize(Frame *fr);
